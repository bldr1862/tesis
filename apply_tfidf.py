...
OUTPUT_PATH = params.REDUCED_TFIDF_DESCRIPTORS_VAL_PATH

captions = utils.readCaptions(DATA_PATH)
stemmed_dict = utils.stemming(captions)

bigram_vectorizer = utils.importPickle(params.REDUCED_BIGRAM_MODEL)
transformer = utils.importPickle(params.REDUCED_TF_IDF_MODEL)
